...
inline const std::vector<UiDescriptor>& allDescriptors()
{
    ...
    static const std::vector<UiDescriptor> table = {
        ...
        { i::inputFormat,      "param.inputFormat",      "",             1.0,  Kind::combo,  false, true,  Domain::inputs,
            { "enum.inputFormat.mono",  "enum.inputFormat.hoa1", "enum.inputFormat.hoa2",
              "enum.inputFormat.hoa3",  "enum.inputFormat.hoa4", "enum.inputFormat.hoa5",
              "enum.inputFormat.hoa6",  "enum.inputFormat.hoa7", "enum.inputFormat.hoa8",
              "enum.inputFormat.hoa9",  "enum.inputFormat.hoa10" } },
