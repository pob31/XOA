/*
    XoaFileFormatTests.cpp - WP6 C1 large-channel file-format spike.

    Green CI on the three OSes is the verdict that stock juce_audio_formats
    reads/writes 121-128-channel files correctly. Kept after the file player
    was removed (D48): any future file import/export (offline-render --wav,
    the possible sampler player) builds on this proof.
